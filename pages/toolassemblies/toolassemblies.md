...
permalink: toolassemblies/toolassemblies
---
...
The tools can be mapped to the different stages of the [data life cycle]({{site.baseurl}}/toolassemblies/data_lifecycle)
...
![Tool assemblies and the data life cycle]({{site.baseurl}}/assets/img/toolassemblies/datalifecycle_mapping.png)