...
* [GDPR 4 Data Support](https://researchdata.nl/en/gdpr-4-data-support/), also provided by [Research Data Netherlands](https://researchdata.nl), is an introductory course for data professionals / data stewards who help researchers deal with privacy sensitive data. All course materials are publicly available. 
...
* [FAIR lesson plans](https://elixir-europe-training.github.io/ELIXIR-TrP-FAIR-Converge/) (in development).

You can also consider joining a community of trainers.
* the [LEARNFAIR](https://learn-fair.nl/) community of FAIR trainers collaborates on Open Educational Resources (among which the FAIR lesson plans) for training in FAIR in the Life Sciences & Health domain;
* the [ELIXIR Training Platform](https://elixir-europe.org/platforms/training) aims to develop a training community that spans all ELIXIR member states; 
