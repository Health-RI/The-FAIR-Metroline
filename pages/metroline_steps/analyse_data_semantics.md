...
| Source Identifier       | None                                                | Missing in the example to unambiguously identify the institute.                            | ROR identifier that is specific to the (research) institute.                        | ROR identifier                    | https://ror.org/example                                                                                                                    |
