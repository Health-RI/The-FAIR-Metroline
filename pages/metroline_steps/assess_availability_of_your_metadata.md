...
* The [FAIRGenomes codebook](https://decor.nictiz.nl/ad/#/fairgenomes-/project/overview), hosted on {% include toolassemblies/show-badges.html ids="art-decor" %}, serves as an example of **structural metadata**.
