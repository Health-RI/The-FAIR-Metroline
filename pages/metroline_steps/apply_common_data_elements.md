...
* Third, if you can't find any CDEs for reuse, ask an expert in the field to help you find appropriate standards or try looking for a well-accepted codebook in, for example, {% include toolassemblies/show-badges.html ids="art-decor" %}.
